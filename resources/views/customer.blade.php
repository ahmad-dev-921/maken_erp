...
<div class="mk-page">
    ...
    <div class="form-grid">
        ...
        <div class="mk-field">
            ...
            <div class="mk-input-wrap">
                ...
                <input type="email" id="email" class="mk-input" placeholder="Enter email">
            </div>
        </div>
        ...
        <div class="mk-field">
            ...
            <div class="mk-input-wrap">
                ...
                <input type="number" id="phone" class="mk-input" placeholder="Enter phone number" required>
            </div>
        </div>
        ...
        <div class="mk-field">
            ...
            <div class="mk-input-wrap">
                <i class="fas fa-location-dot ico"></i>
                <input type="text" id="address" class="mk-input" placeholder="Enter address" required>
            </div>
        </div>
    ...
    <div class="form-actions">
        ...
        <button type="submit" class="btn-amber" id="saveBtn">
            <i class="fas fa-floppy-disk"></i> Save Customer
        </button>
    </div>
</form>
        </div>
    ...
    axios.get(apiBase + '?limit=1000')
        ...
        .catch(() => {
            document.getElementById('customerTableBody').innerHTML =
                '<tr><td colspan="6" class="empty-cell">Failed to load customers.</td></tr>';
        });
}
...
function render() {
    ...
    document.getElementById('customerTableBody').innerHTML = filtered.map((p, i) => `
        <tr>
            <td>${i+1}</td>
            ...
            <td style="text-align:center;">
                <div style="display:flex; gap:4px; justify-content:center;">
                    ...
                    <button class="act-btn del" onclick="deleteCustomer(${p.id})">
